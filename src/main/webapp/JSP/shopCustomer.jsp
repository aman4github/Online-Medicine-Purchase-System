...
<%!
    String shortText(String s) {
        if (s == null) return "";
        int limit = 25; // show first 15 chars
...
<body style="background-color: #C1E59F">
    ...
    <%
        ...
        // Query
        ops = (OraclePreparedStatement) oconn.prepareCall("SELECT * FROM STOCK WHERE QUANTITY >= 1 ORDER BY CREATED_AT DESC");
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-footer">
                                ...
                                <form action="../addToCart" method="post">
                                        ...
                                        <input type="text" name="fdest" value="shop" style="display: none;">
                                        <button type="submit" class="actionkyc">Add to Cart</button><br>
                                    </form>
                            </div>
                        </div>
                    </div>
