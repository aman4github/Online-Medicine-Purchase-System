...
//            vstateacc = request.getParameter("facc");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("SELECT * FROM CUSTOMER ORDER BY CREATED_AT DESC");
//            ops.setString(1, vstateacc);
        ...
        <section class="main">
            <div class="main-top">
                <h1>Customer Account Closure List</h1>
                ...
                <%
                    ...
                    <%
                       for(counter = 1; counter <= orsmd.getColumnCount(); counter ++)
                        ...
                        %>
                                <td>
                                    <form action="../../accountClosure" method="post">
                                    	<input type="text" name="fuserid" value="<%=ors.getString("ID")%>" style="display: none;">
                                        <input type="text" name="fname" value="<%=ors.getString("NAME")%>" style="display: none;">
                                        <input type="text" name="fmail" value="<%=ors.getString("EMAIL")%>" style="display: none;">
                                        <button type="submit" class="actionkyc">CLOSE</button><br>
                                    </form>
                                </td>
                            </tr>
                <%
