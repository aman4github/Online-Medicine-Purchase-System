...
<%!
        ...
        %>
        <%
	       String vMEDNAME = request.getParameter("medName");
//            vstateacc = request.getParameter("facc");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("SELECT s.name AS medi_name, sr.* FROM stock_record sr JOIN stock s ON sr.stock_id = s.stock_id WHERE sr.stock_id = ? order by sr.record_date desc");
            		
            ops.setString(1, vMEDNAME);
...
//            ops.setString(1, vstateacc);
        ...
        <section class="main">
            <div class="main-top">
                <h1>All Records List By ID / Name</h1>
                <a href="records.jsp">
