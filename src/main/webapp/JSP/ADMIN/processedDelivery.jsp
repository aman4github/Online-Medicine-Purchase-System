...
<body style="background-color: #7E998A">
    <%!
            String vname;
            %>
        <%
...
//            vstateacc = request.getParameter("facc");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("SELECT ORDER_TIME, ORDER_ID, CUSTOMER_ID, STOCK_NAME AS MEDICINE_NAME, QUANTITY, TOTAL_PRICE, PAYMENT_TYPE, DELIVERY_STATUS FROM ORDERS WHERE (DELIVERY_STATUS = 'DELIVERED') OR (DELIVERY_STATUS = 'DECLINED') ORDER BY ORDER_TIME DESC");
