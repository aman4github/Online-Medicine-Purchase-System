...
//            vstateacc = request.getParameter("facc");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("SELECT s.name AS medi_name, sr.* FROM stock_record sr JOIN stock s ON sr.stock_id = s.stock_id where s.stock_id = ? order by sr.record_date desc");
