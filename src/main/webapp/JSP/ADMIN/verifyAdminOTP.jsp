            ...
            <div class="collapse navbar-collapse pre-nav" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item active"  aria-current="page" >
                        <a class="nav-link" href="#">Admin OTP Verification Form</a>
                    </li>
                </ul>
            ...
            try
{
            if(sess1!=null) 
            {
                vname = sess1.getAttribute("fnameadmin").toString();
                votp = sess1.getAttribute("otp").toString();
                vemail = sess1.getAttribute("email").toString();
            }
}
catch(Exception ex)
{
