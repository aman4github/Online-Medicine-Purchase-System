...
<body style="background-color: #BBC5AA">
     <%!
            String vname, vusername, vphone, vemail, vid, vpassword, vaddress, vcity, vgender, vpin, vdistrict, vstate;
            %>
        <%
...
//            vstateacc = request.getParameter("facc");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("SELECT ORDER_TIME, ORDER_ID, STOCK_NAME AS MEDICINE_NAME, QUANTITY, TOTAL_PRICE, PAYMENT_TYPE, DELIVERY_STATUS FROM ORDERS WHERE CUSTOMER_ID = ? ORDER BY ORDER_TIME DESC");
            ops.setString(1, vid);
