...
<head>
    ...
    <title>Payment OTP Verification</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse pre-nav" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="cartCustomer.jsp">Cart</a>
                    </li>
                    <li class="nav-item active"  aria-current="page" >
                        <a class="nav-link" href="#">Payment OTP Verification Form</a>
                    </li>
                </ul>
                ...
                <!-- Modal ends here  -->
                <a href="paymentGateway.jsp">
                    <button type="button" class="btn btn-help" data-bs-dismiss="modal">Cancel</button>
                </a>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-close">
                    <form action="../orderPlacingServlet" method="post">
    ...
    <script>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Hello, <%=vname%> .<br>Please verify your Payment .<br>
                        Mail has been sent to your email - <%=vemail%> .</p>
                </div>
                <div class="modal-close">
