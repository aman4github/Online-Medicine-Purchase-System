...
@WebServlet("/UserNameChangeDashboard")
public class UserNameChangeDashboard extends HttpServlet {
    String vNewUsername, vUsername, vaccNum, vaccType, vEMAIL, vNAME;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Class - UserNameChangeDashboard called");
        try (PrintWriter out = response.getWriter()) {
            ...
            vNewUsername = request.getParameter("username");
            ...
            try {
                ...
                ops = (OraclePreparedStatement) oconn
                        .prepareCall("UPDATE CUSTOMER SET USERNAME = (?) WHERE EMAIL = (?)");

                // STEP 6: FILLING UP THE BLANK QUERY PARAMETERS (?)

                ops.setString(1, vNewUsername);
                ...
                if (x > 0) {
                    ...
                    String msg = "Username Change Failed...<br>Please Try again after some time...";
                    String pathLink = "/online-medicine-purchase-system/Logout";
                    String title = "Username Change";
                    String navtitle = "Username Change Failure";
            ...
            // STEP 9: FORMATTING THE CATCH CLAUSE
                ...
                Logger.getLogger(UserNameChangeDashboard.class.getName()).log(Level.SEVERE, null, ex);
                out.println("<h2 style='color:red'> Error is : " + ex.toString() + "</h2>");

                String msg = "Username already exist.<br>Please try with another Username...";
