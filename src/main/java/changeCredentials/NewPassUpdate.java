...
public class NewPassUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Class - NewPassUpdate called");
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ops = (OraclePreparedStatement) oconn.prepareCall("UPDATE CUSTOMER SET PASSWORD =? WHERE USERNAME =?");
                ...
                if (x > 0) {
                    ...
                    String title = "Password Change Failure";
            ...
            // STEP 9: FORMATTING THE CATCH CLAUSE
                ...
                Logger.getLogger(NewPassUpdate.class.getName()).log(Level.SEVERE, null, ex);
