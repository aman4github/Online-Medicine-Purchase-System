...
@WebServlet("/accountClosure")
public class AccountClosure extends HttpServlet {
    String vMAIL, vUSERNAME, vNAME, vUSERID;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Class - AccountClosure called");
        try {
            if (sess != null) {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            vMAIL = request.getParameter("fmail");
            vNAME = request.getParameter("fname");
            vUSERID = request.getParameter("fuserid");
            ...
            try {
                ...
                ops = (OraclePreparedStatement) oconn.prepareCall("DELETE FROM CUSTOMER WHERE EMAIL = ?");
                ops2 = (OraclePreparedStatement) oconn
                        .prepareCall("DELETE FROM ORDERS WHERE CUSTOMER_ID = ? AND DELIVERY_STATUS = 'PENDING'");

                // STEP 6: FILLING UP THE BLANK QUERY PARAMETERS (?)

                ops.setString(1, vMAIL);
                ops2.setString(1, vUSERID);
                ...
                if (x > 0) {
                    ...
                    sess.setAttribute("vMAIL", vMAIL);
                    sess.setAttribute("vNAME", vNAME);

                    RequestDispatcher rd = request.getRequestDispatcher("/closure_mail");
                    rd.forward(request, response);

                } else {
                    String msg = "Account Closed Failed...";
                    String pathLink = "/online-medicine-purchase-system/JSP/ADMIN/accountClosure.jsp";
                    String title = "Account Closure";
                    String navtitle = "Account Closure Failed";
            ...
            // STEP 9: FORMATTING THE CATCH CLAUSE
                ...
                Logger.getLogger(AccountClosure.class.getName()).log(Level.SEVERE, null, ex);
